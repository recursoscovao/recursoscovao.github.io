...
const JOGO_CONFIG = {
    ...
    links: {
        home: "../", 
        pre: "../pre",
        jd: "../destaques", // Nota: O código no Index vai saltar esta chave 'jd' conforme pedido
        ano1: "../1",
        ano2: "../2",
        ano3: "../3",
        ano4: "../4"
...
const DADOS_JOGO_MEMORIA = {
    ...
    itens: [
        ...
        { id: 7, img: "vaca.png", nome: "Vaca" },
        { id: 7, img: "pato.png", nome: "Pato" },
        { id: 7, img: "gato.png", nome: "Gato" },
        { id: 7, img: "cao.png", nome: "Cão" },
        { id: 8, img: "cavalo.png", nome: "Cavalo" }
    ]
};
