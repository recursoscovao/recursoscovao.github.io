...
const DADOS_JOGO = {
    ...
    itens: [
        { id: 1,  img: "vaca.png", som: "vaca.mp3", pasta: "domesticos" },
        ...
        { id: 6,  img: "coelho.png", som: "coelho.mp3", pasta: "domesticos" },
        { id: 7,  img: "galinha.png", som: "galinha.mp3", pasta: "domesticos" },
        { id: 8,  img: "galo.png", som: "galo.mp3", pasta: "domesticos" },
        { id: 9, img: "gato.png", som: "gato.mp3", pasta: "domesticos" },
        { id: 10, img: "ovelha.png", som: "ovelha.mp3", pasta: "domesticos" },
        { id: 11, img: "pato.png", som: "pato.mp3", pasta: "domesticos" },
        { id: 12, img: "peru.png", som: "peru.mp3", pasta: "domesticos" },
        { id: 13, img: "porco.png", som: "porco.mp3", pasta: "domesticos" },
        { id: 14, img: "vaca.png", som: "vaca.mp3", pasta: "domesticos" },
        { id: 15, img: "abelha.png", som: "abelha.mp3", pasta: "selvagens" },
        { id: 16, img: "abutre.png", som: "abutre.mp3", pasta: "selvagens" },
        { id: 17, img: "aguia.png", som: "aguia.mp3", pasta: "selvagens" },
        { id: 18, img: "aranha.png", som: "aranha.mp3", pasta: "selvagens" },
        { id: 19, img: "avestruz.png", som: "avestruz.mp3", pasta: "selvagens" },
        { id: 20, img: "baleia.png", som: "baleia.mp3", pasta: "selvagens" },
        { id: 21, img: "borboleta.png", som: "borboleta.mp3", pasta: "selvagens" },
        { id: 22, img: "canguru.png", som: "canguru.mp3", pasta: "selvagens" },
        { id: 23, img: "caracol.png", som: "caracol.mp3", pasta: "selvagens" },
        { id: 24, img: "caranguejo.png", som: "caranguejo.mp3", pasta: "selvagens" },
        { id: 25, img: "coala.png", som: "coala.mp3", pasta: "selvagens" },
        { id: 26, img: "crocodilo.png", som: "crocodilo.mp3", pasta: "selvagens" },
        { id: 27, img: "elefante.png", som: "elefante.mp3", pasta: "selvagens" },
        { id: 28, img: "foca.png", som: "foca.mp3", pasta: "selvagens" },
        { id: 29, img: "formiga.png", som: "formiga.mp3", pasta: "selvagens" },
        { id: 30, img: "girafa.png", som: "girafa.mp3", pasta: "selvagens" },
        { id: 31, img: "gorila.png", som: "gorila.mp3", pasta: "selvagens" },
        { id: 32, img: "hiena.png", som: "hiena.mp3", pasta: "selvagens" },
        { id: 33, img: "hipopotamo.png", som: "hipopotamo.mp3", pasta: "selvagens" },
        { id: 34, img: "leao.png", som: "leao.mp3", pasta: "selvagens" },
        { id: 35, img: "lobo.png", som: "lobo.mp3", pasta: "selvagens" },
        { id: 36, img: "macaco.png", som: "macaco.mp3", pasta: "selvagens" },
        { id: 37, img: "morcego.png", som: "morcego.mp3", pasta: "selvagens" },
        { id: 38, img: "panda.png", som: "panda.mp3", pasta: "selvagens" },
        { id: 39, img: "papagaio.png", som: "papagaio.mp3", pasta: "selvagens" },
        { id: 40, img: "peixe.png", som: "peixe.mp3", pasta: "selvagens" },
        { id: 41, img: "polvo.png", som: "polvo.mp3", pasta: "selvagens" },
        { id: 42, img: "pombo.png", som: "pombo.mp3", pasta: "selvagens" },
        { id: 43, img: "raia.png", som: "raia.mp3", pasta: "selvagens" },
        { id: 44, img: "raposa.png", som: "raposa.mp3", pasta: "selvagens" },
        { id: 45, img: "rato.png", som: "rato.mp3", pasta: "selvagens" },
        { id: 46, img: "rinosseronte.png", som: "rinosseronte.mp3", pasta: "selvagens" },
        { id: 47, img: "tartaruga.png", som: "tartaruga.mp3", pasta: "selvagens" },
        { id: 48, img: "texugo.png", som: "texugo.mp3", pasta: "selvagens" },
        { id: 49, img: "tigre.png", som: "tigre.mp3", pasta: "selvagens" },
        { id: 50, img: "tubarao.png", som: "tubarao.mp3", pasta: "selvagens" },
        { id: 51, img: "tucano.png", som: "tucano.mp3", pasta: "selvagens" },
        { id: 52, img: "urso.png", som: "urso.mp3", pasta: "selvagens" },
        { id: 53, img: "zebra.png", som: "zebra.mp3", pasta: "selvagens" }
    ]
};
